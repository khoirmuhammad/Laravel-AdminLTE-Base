                        ...
                        if (response.male_data != null)
                        {
                            for(let i = 0; i < response.male_data.length; i++) {
                                row += `<tr>
                                    ...
                                    <td>` + `Laki-laki` + `</td>
                                    <td>` + response.male_data[i].level + `</td>
                                    <td>` + response.male_data[i].education + `</td>
                                    <td>` + response.male_data[i].status + `</td>
                        ...
                        if (response.female_data != null)
                        {
                            for(let i = 0; i < response.female_data.length; i++) {
                                row += `<tr>
                                    ...
                                    <td>` + `Perempuan` + `</td>
                                    <td>` + response.female_data[i].level + `</td>
                                    <td>` + response.female_data[i].education + `</td>
                                    <td>` + response.female_data[i].status + `</td>
        ...
        $('#btnStore').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if (response.data_delete.length > 0) {
