...
$(document).ready(function() {
  ...
  if ($('#role_type').val() != 'ppk') {
    ...
    buttons = `
    <div class="btn-group" role="group" aria-label="Button">
      <button type="button" id="add-pjkelas" class="btn btn-primary btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i> Tambah Data</button>
      <button type="button" id="print-pjkelas" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Cetak Data</button>
    </div>
    `;
  }
