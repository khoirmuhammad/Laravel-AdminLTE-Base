...
class Student extends Model
{
    ...
    public static function select_student_general_by_level_gender()
    {
        $result = DB::table('students')
                ->leftJoin('levels', 'students.level', '=', 'levels.id')
                ->where('students.group', '=', session('group')) //7079bef5-d75c-11ec-b5a0-5ce0c508bbb3
    ...
    public static function select_student_general_by_level_education()
    {
        $result = DB::table('students')
                ->leftJoin('education', 'students.education', '=', 'education.id')
                ->where('students.group', '=', session('group')) // 7079bef5-d75c-11ec-b5a0-5ce0c508bbb3
    ...
    public static function select_student_caberawit_by_class_and_gender()
    {
    ...
    public static function select_student_praremaja_by_gender()
    {
        $result = DB::table('students')
                ->where('group', '=', session('group')) // 7079bef5-d75c-11ec-b5a0-5ce0c508bbb3
    ...
    public static function select_student_remaja_by_gender()
    {
        $result = DB::table('students')
                ->where('group', '=', session('group')) //7079bef5-d75c-11ec-b5a0-5ce0c508bbb3
    ...
    public static function select_student_unik_by_education_and_gender()
    {
        $result = DB::table('students')
                ->leftJoin('education', 'students.education', '=', 'education.id')
                ->where('students.group', '=', session('group')) //'7079bef5-d75c-11ec-b5a0-5ce0c508bbb3'
    ...
    public static function select_student_unik_pribumi_status()
    {
        $result = DB::table('students')
                ->where('group', '=', session('group')) //7079bef5-d75c-11ec-b5a0-5ce0c508bbb3
    ...
    public static function select_student_unik_nonpribumi_status()
    {
        $result = DB::table('students')
                ->where('group', '=', session('group')) // 7079bef5-d75c-11ec-b5a0-5ce0c508bbb3
                ->where('level', '=', '3110c8d4-d75c-11ec-b5a0-5ce0c508bbb3')
